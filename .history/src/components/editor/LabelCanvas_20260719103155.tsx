...
export default function LabelCanvas() {
  ...
  const { template, zoom, selectedElementId, setSelectedElementId, updateElement, deleteSelected } = useEditorStore()
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        selected ? "ring-2 ring-emerald-400 ring-offset-2 ring-offset-white" : "ring-1 ring-transparent",
                      )}
                    ...
                    >
                      {el.type === "text" ? (
                        ...
                        <img
                          ...
                          alt=""
                          draggable={false}
                          className={cn("h-full w-full", el.data.fit === "contain" ? "object-contain" : "object-cover")}
                        />
                      )}
                    </div>
                  </Rnd>
