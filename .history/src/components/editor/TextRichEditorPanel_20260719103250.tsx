...
import { AlignCenter, AlignLeft, AlignRight, Bold, Italic, Underline as UnderlineIcon } from "lucide-react"
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          className={toolBtn(editor?.isActive({ textAlign: "center" }) ?? false)}
          disabled={!canUse}
